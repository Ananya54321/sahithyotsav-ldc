...
export const eventsConfig: EventConfig[] = [
  ...
  { name: "Workshop – Engaging Public Speaking", fee: 30, gradient: "linear-gradient(135deg, #4a009e 0%, #7c3aed 100%)", image: "/posters/workshop_on_public_speaking.png", closed: true },
  ...
  { name: "Talk on Emotional Intelligence - Being Human in a High-Tech World", fee: 50, gradient: "linear-gradient(135deg, #3d1080 0%, #a78bfa 100%)", image: "/events/emotional_intelligence.png", closed: true },
  { name: "Alumni Talk", fee: 0, gradient: "linear-gradient(135deg, #1a003d 0%, #6d28d9 100%)", image: "/events/alumni_talk.png", closed: true },
  { name: "Kaavya Manch – Open Mic Poetry", fee: 0, gradient: "linear-gradient(135deg, #2d006b 0%, #8b5cf6 100%)", image: "/posters/kavyamanch.png", closed: true },
  { name: "Declamation on Harry Potter Series Competition", fee: 50, gradient: "linear-gradient(135deg, #2d006b 0%, #c084fc 100%)", image: "/posters/harry_potter_declamation.png", closed: true }
];
